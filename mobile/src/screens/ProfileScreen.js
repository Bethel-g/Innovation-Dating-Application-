...
const styles = StyleSheet.create({
  ...
  verified: { fontSize: 14, color: '#00b894', marginTop: 4 },
  ...
  interest: { backgroundColor: '#f0f0f0', paddingHorizontal: 14, paddingVertical: 6, borderRadius: 16 },
  interestText: { fontSize: 14, color: '#2d3436' },
